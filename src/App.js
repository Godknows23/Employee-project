...
class App extends Component {
  ...
  login() {
    ...
    email === "godknowspesanai@gmail.com" && password === "login" ? this.setState({
      user:{
        email : email,
        password : password    
      }
  ...
  updateEmployee(){
    ...
    this.state.editedPhone && (this.state.employeeList[edI].phone = this.state.editedPhone)
    this.state.editedEmail && (this.state.employeeList[edI].email = this.state.editedEmail)
    this.state.editedNationalId && (this.state.employeeList[edI].nationalId = this.state.editedNationalId)
    this.state.editedDepartment && (this.state.employeeList[edI].department = this.state.editedDepartment)
            ...
            <table className="table table-striped table-dark">
              <thead>
                 <tr>
                  ...
                  <th scope="col" className="centerAll">Phone</th>
                  <th scope="col" className="centerAll">Email</th>
                  <th scope="col" className="centerAll">nationalId</th>
              ...
              {this.state.employeeList.map((value, index)=>{
                    return(
                      this.state.editIndex !== index ? <tr>
                            ...
                            <td className="centerAll" id={index+4}>{value.phone}</td>
                            <td className="centerAll" id={index+5}>{value.email}</td>
                            <td className="centerAll" id={index+6}>{value.nationalId}</td>
                            <td className="centerAll" id={index+7}>{value.department}</td>
                            <td className="centerAll" id={index+8}>${value.salary}</td>
                            <td className="centerAll" id={index+9}>{value.joinDate}</td>
                            <td className="centerAll" id={index+10}><button onClick={()=>{
                              this.editEmployee(index)
                            }} className="btn btn-primary">Edit</button></td>
                            <td className="centerAll" id={index+11}><button onClick={()=>{
                          ...
                          <td className="centerAll" id={index+4+'edit'}><input type="text" defaultValue={value.phone} onChange={this.updatePhone} /></td>
                          <td className="centerAll" id={index+5+'edit'}><input type="text" defaultValue={value.email} onChange={this.updateEmail} /></td>
                          <td className="centerAll" id={index+6+'edit'}><input type="text" defaultValue={value.nationalId} onChange={this.updateNationalId} /></td>
                          <td className="centerAll" id={index+7+'edit'}><input type="text" defaultValue={value.department} onChange={this.updateDepartment} /></td>
                          <td className="centerAll" id={index+8+'edit'}><input type="text" defaultValue={value.salary} onChange={this.updateSalary}/></td>
                          <td className="centerAll" id={index+9+'edit'}><input type="text" defaultValue={value.joinDate}/></td>
    ...
    return(
      <div className="loginForm">
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="phone" aria-describedby="emailHelp" placeholder="Enter Phone#"/>
        </div>
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" id="nationalId" aria-describedby="emailHelp" placeholder="Enter National ID"/>
        </div>
        <div className="form-group">
          <label >Department</label>
          <input type="text" className="form-control" id="department" aria-describedby="emailHelp" placeholder="Enter department"/>
        </div>
        <div className="form-group">
          <label >Salary</label>
          <input type="text" className="form-control" id="salary" aria-describedby="emailHelp" placeholder="Enter Salary"/>
        </div>
        <button class="btn_submit" onClick={()=>{
      ...
      <div className="logOut">
        <button className="btn btn-warning" onClick={()=>{
         ...
         <button class="btn_add" onClick={()=>{
            this.addEmployee()
          }}><i class="material-icons">Add Employee</i></button>
      </div>
    )
  }
